...
public class CreateTestCasePage : BasePage
{
    ...
    private static readonly By AddAttachmentBy = By.ClassName("ES46lo");
    private static readonly By FileDropperBy = By.CssSelector("input[type='file']");
    private static readonly By ImgBy = By.CssSelector("a[class~='QLCGNZ']");
    ...
    private Button AddAttachmentButton => new Button(Driver, AddAttachmentBy);
    private Input FileDropper => new Input(Driver, FileDropperBy);
    private IWebElement Img => WaitsHelper.WaitForExists(ImgBy);
    ...
    public void AddAttachment(string fileName)
    {
        ...
        string filePath = Path.Combine(assemblyPass, "Resources", fileName);
        AddAttachmentButton.Click();
        FileDropper.SendKeys(filePath);
    }
